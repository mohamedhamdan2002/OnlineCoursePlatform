...
public static class ApplicationErrors
{
    ...
    public static Error ReviewNotFound = new Error(404, "Review is Not Found");
    ...
    public static Error UnauthorizedAction = new Error(403, "You are not allowed to perform this action");
}
